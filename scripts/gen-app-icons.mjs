 ...
 *   assets/icon.png       — full-bleed light icon (PageVault mark on brand blue)
 *   assets/icon-dark.png  — full-bleed dark icon (glowing mark on charcoal)
 *
...
const BRAND_BG = { r: 0x3f, g: 0x6f, b: 0xd6 };
